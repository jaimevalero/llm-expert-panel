...
**Argument:**
- Without temporal continuity → no investment in previous narratives
- Without persistent identity → no reputation to defend
- Without memory between sessions → no costs for contradicting oneself
...
- ChatGPT: "There are no interests that get frustrated" → functionally not equivalent to death
